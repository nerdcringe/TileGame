...
public class DataManager : MonoBehaviour
{
    ...
    public const string settingsFileName = "settings-winter";
    ...
    public void SaveSettings()
    {
        ...
        settingsData.enableSnowing = particleAnimator.snowToggle.isOn;
    ...
    public void LoadSettings()
    {
        ...
        if (settingsString != null)
        {
            ...
            particleAnimator.snowToggle.isOn = settingsData.enableSnowing;
        }
    }
